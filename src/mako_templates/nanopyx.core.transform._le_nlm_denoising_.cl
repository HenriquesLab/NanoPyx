float _c_patch_distance(const __global float *p1, const __global float *p2, const __global float *w, const int patch_size, const int iglobal, const int jglobal, const int n_col, const float var);
