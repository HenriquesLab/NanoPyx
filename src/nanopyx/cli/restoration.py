...
def linkinpy_non_local_means_denoising_main() -> None:
    ...
    parser.add_argument("--patch-size", "--patch_size", dest="patch_size", type=int, default=7)
    parser.add_argument("--patch-distance", "--patch_distance", dest="patch_distance", type=int, default=11)
