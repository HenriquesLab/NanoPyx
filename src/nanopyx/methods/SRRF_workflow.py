...
def SRRF(image, magnification, ringRadius, border, radialityPositivityConstraint, doIntensityWeighting):
    ...
    _SRRF = Workflow((CRShiftAndMagnify,(image, 0,0,magnification,magnification),{}),
                    (Radiality,(image, 'PREV_RETURN_VALUE'),{'magnification':magnification, 'ringRadius':ringRadius, 'border':border,'radialityPositivityConstraint':radialityPositivityConstraint,'doIntensityWeighting':doIntensityWeighting}))
