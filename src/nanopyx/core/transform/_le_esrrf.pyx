...
from .interpolation import fht_space_interpolation as dht_interpolation
...
class eSRRF(LiquidEngine):
    ...
    def run(self, image, magnification: int = 5, radius: float = 1.5, sensitivity: float = 1, use_fht: bool = False, doIntensityWeighting: bool = True, pad_edges: bool = False, run_type=None):
        image = check_image(image)
        return self._run(image, magnification=magnification, radius=radius, sensitivity=sensitivity, use_fht=use_fht, doIntensityWeighting=doIntensityWeighting,
        pad_edges=pad_edges, run_type=run_type)

    def benchmark(self, image, magnification: int = 5, radius: float = 1.5, sensitivity: float = 1, use_fht: bool = False, doIntensityWeighting: bool = True, pad_edges: bool = False):
        image = check_image(image)
        return super().benchmark(image, magnification=magnification, radius=radius, sensitivity=sensitivity, use_fht=use_fht, doIntensityWeighting=doIntensityWeighting, pad_edges=pad_edges)

    def _run_opencl(self, image, magnification=5, radius=1.5, sensitivity=1, use_fht=False, doIntensityWeighting=True, pad_edges=False, device=None, mem_div=1):
        """
        @gpu
        """
        runtype = "OpenCL"
        ...
        if use_fht:
            ...
            output_image = rgc.run(gradient_col_interp, gradient_row_interp, magnified_image, magnification=magnification, radius=radius, sensitivity=sensitivity, doIntensityWeighting=doIntensityWeighting, pad_edges=pad_edges, run_type=runtype)
        else:
            if device is None:
    ...
    def _run_threaded(self, image, magnification=5, radius=1.5, sensitivity=1, use_fht=False, doIntensityWeighting=True, pad_edges=False):
        """
        @cpu
        @threaded
        @cython
    ...
    def _run_threaded_guided(self, image, magnification=5, radius=1.5, sensitivity=1, use_fht=False, doIntensityWeighting=True, pad_edges=False):
        """
        @cpu
        @threaded
        @cython
        ...
        return radial_gradients
    def _run_threaded_dynamic(self, image, magnification=5, radius=1.5, sensitivity=1, use_fht=False, doIntensityWeighting=True, pad_edges=False):
        """
        @cpu
        @threaded
        @cython
        ...
        return radial_gradients
    def _run_threaded_static(self, image, magnification=5, radius=1.5, sensitivity=1, use_fht=False, doIntensityWeighting=True, pad_edges=False):
        """
        @cpu
        @threaded
        @cython
    ...
    def _run_unthreaded(self, image, magnification=5, radius=1.5, sensitivity=1, use_fht=False, doIntensityWeighting=True, pad_edges=False):
        """
        @cpu
        @cython
        """
