<%!
from ...scripts/.c2cl import extract_function_code, extract_define_code, confirm_c_file_absolute_path
%>
% if inter_name=="lanczos":
...
% if inter_name=="lanczos":
<%
c_file = confirm_c_file_absolute_path(f"_c_interpolation_{inter_name}.c")
c_code = extract_function_code(open(c_file).read(), "_c_lanczos_kernel")
%>
${c_code}
% endif
...
<%
c_file = confirm_c_file_absolute_path(f"_c_interpolation_{inter_name}.c")
c_code = extract_function_code(open(c_file).read(), "_c_interpolate")
%>
${c_code}
