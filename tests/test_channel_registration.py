...
from nanopyx.methods.channel_registration import (
...
def test_channel_registration_init():
    random_channel_misalignment = generate_channel_misalignment()
    aligned_img = estimate_channel_registration(
        random_channel_misalignment,
        0,
        200,
        3,
    ...
    aligned_tmp = estimate_channel_registration(
        random_channel_misalignment,
        0,
        200,
        3,
...
def test_channel_registration_apply_init():
    random_channel_misalignment = generate_channel_misalignment()
    channel_registrator = (
        channel_registration.estimator.ChannelRegistrationEstimator()
    )
    aligned_image = channel_registrator.estimate(
        random_channel_misalignment,
        0,
        200,
        3,
    ...
    aligned_image_2 = apply_channel_registration(
        random_channel_misalignment,
